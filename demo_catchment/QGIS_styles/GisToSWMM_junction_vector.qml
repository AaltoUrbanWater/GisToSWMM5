...
<qgis version="2.18.11" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="inv_elev">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{86abe8e3-a26f-4924-a272-2f9ed5192740}">
      <rule filter=" &quot;open&quot; =1" key="{be69c058-000d-4450-8cba-d57b2a80f6ea}" symbol="0" label="open"/>
      <rule filter=" &quot;open&quot; =0" key="{33ecc440-91f1-4167-9e5a-d86938cbc250}" symbol="1" label="closed"/>
    </rules>
    <symbols>
  ...
  <annotationform>C:/Users/Lassi/Dropbox/Labra/URCA/GIS/old</annotationform>
  <aliases>
    <alias field="name" index="0" name=""/>
    <alias field="elevation" index="1" name=""/>
    <alias field="notes" index="2" name=""/>
    <alias field="inv_elev" index="3" name=""/>
    <alias field="max_depth" index="4" name=""/>
    <alias field="open" index="5" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;elevation&quot;" sortOrder="1">
    <columns>
      <column width="-1" hidden="0" type="field" name="name"/>
      <column width="-1" hidden="0" type="field" name="elevation"/>
      <column width="-1" hidden="0" type="field" name="notes"/>
      <column width="-1" hidden="0" type="field" name="inv_elev"/>
      <column width="-1" hidden="0" type="field" name="max_depth"/>
      <column width="-1" hidden="0" type="field" name="open"/>
      <column width="-1" hidden="1" type="actions"/>
    </columns>
  </attributetableconfig>
  <editform>C:/Users/Lassi/Dropbox/Labra/URCA/GIS/old</editform>
  <editforminit/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="inv_elev" expression=""/>
    <default field="max_depth" expression=""/>
    <default field="open" expression=""/>
  </defaults>
