...
<qgis version="2.18.11" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="ArrowLine" locked="0">
          <prop k="arrow_start_width" v="0.2"/>
          ...
          <symbol alpha="1" clip_to_extent="1" type="fill" name="@0@0">
            <layer pass="0" class="SimpleFill" locked="0">
              ...
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="168,98,107,0"/>
  ...
  <aliases>
    ...
    <alias field="from" index="1" name=""/>
    <alias field="to" index="2" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="-1856663328">
    <columns>
      <column width="-1" hidden="0" type="field" name="id"/>
      <column width="-1" hidden="0" type="field" name="from"/>
      <column width="-1" hidden="0" type="field" name="to"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="from" expression=""/>
    <default field="to" expression=""/>
  </defaults>
